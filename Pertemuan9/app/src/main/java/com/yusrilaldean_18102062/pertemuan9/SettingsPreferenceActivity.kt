...
import com.yusrilaldean_18102062.pertemuan9.databinding.ActivitySettingsPreferenceBinding

class SettingsPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    private lateinit var mSettingPreference : SettingPreference
    private lateinit var settingModel: SettingModel
    private lateinit var binding: ActivitySettingsPreferenceBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySettingsPreferenceBinding.inflate(layoutInflater)
