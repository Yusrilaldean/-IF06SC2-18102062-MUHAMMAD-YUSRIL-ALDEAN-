package com.yusrilaldean_18102062.pertemuan11.adapter
...
import com.yusrilaldean_18102062.pertemuan11.QuoteAddUpdateActivity
import com.yusrilaldean_18102062.pertemuan11.R
import com.yusrilaldean_18102062.pertemuan11.databinding.ItemQuoteBinding
...
class QuoteAdapter(private val activity: Activity): RecyclerView.Adapter<QuoteAdapter.QuoteViewHolder>() {
    ...
    inner class QuoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(quote: Quote, position: Int) {
            ...
            val timestamp = quote.date as Timestamp
